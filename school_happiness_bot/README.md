...
пользователя фразой «Здравствуйте, мне нужны помощники для создания школы
«Счастья»», ведёт с ним диалог и собирает контакты (имя, город, чем готов
помочь, телефон), сохраняя их в базу SQLite.
